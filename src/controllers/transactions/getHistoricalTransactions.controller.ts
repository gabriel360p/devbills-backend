...
import type { getHistoricalTransactionsSchema } from "../../schemas/transaction.schema";
...
export const getHistoricalTransactions = async(request:FastifyRequest<{Querystring:getHistoricalTransactionsSchema}>, reply:FastifyReply):Promise <void> =>{
