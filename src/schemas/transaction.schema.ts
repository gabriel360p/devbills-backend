...
export const createTransactionSchema = z.object({
 description: z.string().min(1,"Descrição obrigatória"), 
  ...
  categoryId: z.string().refine(isValidObjectId,{message:"Categoria inválida"}),//dá erro, mas o ZOD vai enviar o id por debaixo dos panos, 
...
export const getTransactionsSchema= z.object({
  ...
  type: z.enum([TransactionType.expense,TransactionType.income],{error:"Erro no enum"}).optional(),
  categoryId: z.string().refine(isValidObjectId,{message:"Categoria inválida"}),//dá erro, mas o ZOD vai enviar o id por debaixo dos panos, 
})
